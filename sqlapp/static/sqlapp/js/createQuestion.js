 ...
 let textareaHint = document.getElementById('id_hint');
 let chHint = textareaHint.clientHeight;
 textareaHint.addEventListener('input', ()=>{
     textareaHint.style.height = chHint + 'px';
     let shHint = textareaHint.scrollHeight;
     textareaHint.style.height = shHint + 'px';
 });
